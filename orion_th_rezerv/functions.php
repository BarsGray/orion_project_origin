...
function orion_th_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'orion_th' ),
		)
	);
...
function orion_th_scripts() {
	...
	wp_style_add_data( 'orion_th-style', 'rtl', 'replace' );

	wp_enqueue_script( 'orion_th-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
